...
בספטמבר 2022 התחתנו ועברנו לגור ליד המשפחה שלי בג׳אבליא. היו לנו חיים מאושרים, מלאים במשפחה ובאהבה. 
...
{.testimony typewriter}
התרגשתי מאוד לראות את אחמד. הוא התרגש גם, חיבק ונישק את ריתא בלי הפסקה. אבל המפגש איתו היה גם מזעזע. ראיתי שהוא ירד במשקל באופן דרסטי ואיבד הרבה מהחיוניות שלו. הוא נראה מוטרד ולחוץ. 

במובן מסוים, הרגשתי, הוא איבד את חייו.
...
{.meta}
מתוך המחסן ההרוס, ניבאל הפצועה מצליחה לקרוא לעזרה. היא מתפנה לבית החולים, תוך שהשכנים שלה לוקחים ממנה את ריתא, שלא נפגעה בהפצצה.
...
מה שהחזיק אותי זו הידיעה שריתא לא נפגעה.
...
במהלך התקופה הזו, היחסים בין ניבאל לאחמד הופכים יותר ויותר טעונים. 

החיים תחת אימת ההפצצות המתמדת ותנאי החיים הבלתי-אפשריים מחלחלים אל תוך מערכת היחסים שלהם, בזמן שהם נדרשים להסתגל למגבלות החדשות של ניבאל ולדאוג לריתא הקטנה. 

ניבאל מתארת תסכול מתמשך סביב הניסיון להשיג מים ואוכל במחנה העקורים, תסכול שאחמד מפנה לעתים כלפיה. 


{.testimony typewriter}
בתוך כל הקשיים, ניסיתי להתמקד בריתא. היא הייתה הדבר החשוב ביותר בשבילי, ולמענה התעלמתי מהמצב שלי, מהקושי בקשר עם אחמד ומהתנאים. ניסיתי לדאוג לה ככל שיכולתי.
