...
{.meta}
[](svg/#opening.svg/-0.07,0.21,1.81/+gazamap+IDFareas)
...
`S: בוא נכניס כאן מפה עדכנית של ההרס. קאפשן: מיפוי ההרס ברצועת עזה באוקטובר 2025?`

`M: אני מציע לא להכניס מפה חיה בשלב זה`
