...
התושבים שנאלצים להישאר בג׳אבליא נצפים מסתובבים בין ההריסות, כשהם מנסים לשרוד במאבק על גישה לאוכל ולמים.
...
אחמד הוחזק באחד ממתקני הכליאה הישראליים ללא משפט במשך כחצי שנה. 

אחרים שנעצרו באותם ימים מוחזקים עד היום. תועד כי הם סובלים מאלימות תכופה, קשה ושרירותית, שהפכה מאז אוקטובר 2023 למדיניות מערכתית של ישראל כלפי אסירים פלסטינים.
...
{.testimony typewriter}
[](tbd/#??)
מאז שאחמד שוחרר מהמעצר בישראל וחזר אלינו הוא היה נראה לי מוטרד ולחוץ. משהו בו השתנה.
...
ניבאל, ריתא וכ-50 מבני משפחתן - הוריה של ניבאל, אחיה, בני זוגם וילדיהם - משוטטים ברחובות ג׳אבליא בחיפוש אחר מקום בטוח. 
